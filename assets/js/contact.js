...
(function($) {
    ...
    var FormFunction = function() {
        ...
        var validateInteger = function() {
            if (!checkSelectorExistence('.int-value')) {
                return;
            }
        ...
        var validateCharacter = function() {
            if (!checkSelectorExistence('.valid-character')) {
                return;
            }
        ...
        var contactForm = function() {
            if (!checkSelectorExistence('.ajax-form')) {
                return;
            }
        ...
        var subscriptionForm = function() {
            if (!checkSelectorExistence('.subscribe-form1, .subscribe-form')) {
                return;
            }
